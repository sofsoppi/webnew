...
<div class="container my-5">
	   ...
	   <form id="daftar_user" action="" method="post" onsubmit="return cek_data()">
         <div class="form-group">
           ...
           placeholder="Masukan nomor induk nasabah" name="nin" value="<?php echo $format; ?>" readonly/>
         </div>
         ...
         <div class="form-group">
           ...
           placeholder="Masukan alamat" name="alamat"  autocomplete="off"  />
         </div>
         ...
         <div class="form-group">
           <input type="hidden" class="form-control" 
            name="saldo"  autocomplete="off" />
         </div>
         <div class="form-group">
           <input type="hidden" class="form-control" name="sampah"  autocomplete="off" />
